...
void printResult()
{
    cout<<"skyline point number:"<<BNLresult.size()<<endl;
    if(BNLresult.size()<=10)
        for(int i=0;i<BNLresult.size();i++)
            cout<<BNLresult[i]<<" ";
    cout<<endl;
}
...
int main()
{
	...
	cout << "Createing graph time：" << d1 << "ms" << endl;
